...
namespace WallExporter.Infrastructure
{
    public static class CommonHelper
    {
        ...
        public static string GetFormattedStatusTime(long milliSeconds)
        {
            ...
            {
                result = res.TotalMinutes.ToString("0") + "TotalMinutes";
            }
            else if (res.TotalDays < 1)
            {
                result = res.TotalHours.ToString("0") + ".TotalHours";
            }
            else
            {
                result = res.TotalDays.ToString("0") + ".TotalDays";
            }
        ...
        public static string GetUriOfAttachmentIcon()
        {
            ...
            int count = 0;// App.Current.EntityService.AttachmentPhotos.Count;
